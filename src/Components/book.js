                ...
                <li key = {currentBook.id}>
                    <div className="book">
                        <div className="book-top">
                            {<div className="book-cover" style={{ width: 128, height: 193, backgroundImage: currentBook.imageLinks ? `url("${currentBook.imageLinks["thumbnail"]}")` : "https://picsum.photos/id/237/200/300"}}></div>}
